{ lib }:
{
  ...
  mainSshAuthorizedKeys = [
    ...
    # NOTE: root@VitusMac above is an OLD different key; artemis uses the line below
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHsJsNMjCqrCdB1dItRvB6pbDjbLwnPYlTmunAqcJX18 artemis"
